...
const Documents = () => {
    return (
        <div class="flex w-full flex-col items-center justify-center">
            <FixedImage url="/banners/documents.png" height="40rem">
                <h1 class="font-futur text-white text-center text-6xl">Documents</h1>
            </FixedImage>
            <div class="-mt-48 h-full w-full flex flex-row items-center justify-center p-4 gap-4 font-futur text-xl font-bold">
