...
const Home = () => {
    return (
        <div class="flex w-full flex-col">
            <FixedImage url="/campus2.jpg" extra_classes="h-[90vh] justify-center items-center">
                <div class="h-60">
                    {/* Fix so its always in the center instead */}
                </div>
                ...
                <a
                    class="animate-bounce font-futur text-white text-2xl mt-auto mb-20 cursor-pointer"
