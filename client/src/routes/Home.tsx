    ...
    return (
        <div class="flex w-full flex-col">
            ...
            <FixedImage url="/campus2.jpg" extra_classes="h-[100vh] justify-center items-center">
                ...
                <a class="animate-bounce font-futur text-2xl float-bottom mb-20 cursor-pointer absolute bottom-20" onClick={scrollToMore}>
                    <CaretDoubleDown size={32} weight="bold" class="text-emerald-400" />
                </a>
            </FixedImage>
            <div class="pt-8 flex flex-col gap-4" id="more">
